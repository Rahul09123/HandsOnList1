...
int main(){
	...
	fcntl(fd,F_RDLCK,&lock); //set lock and wait
	...
	fcntl(fd,F_RDLCK,&lock); //free the lock 
	printf("finished\n");
...
Terminal 1: 
asus@asus-TUF-Gaming-FX505DT-FX505DT:~/Desktop/Linux/Program18$ cc ReadRecordLock1.c
...
In the critical section locking 10 bytes of data
Enter into the unlock..



Terminal 2:
asus@asus-TUF-Gaming-FX505DT-FX505DT:~/Desktop/Linux/Program18$ cc ReadRecordLock2.c
asus@asus-TUF-Gaming-FX505DT-FX505DT:~/Desktop/Linux/Program18$ ./a.out
Before entering into critical section
Entering into critical section
In the critical section lockint 5 bytes of data
Enter into the unlock..
